...
import {DiscoverInterMarksSectionComponent} from '@features/discover/sections/discover-inter-marks-section/discover-inter-marks-section';
import {DiscoverContributionSectionComponent} from '@features/discover/sections/discover-contribution-section/discover-contribution-section';

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, DiscoverHeroSectionComponent, DiscoverFeaturesSectionComponent, DiscoverWhyItMattersSection, DiscoverProcessLoopSectionComponent, DiscoverGalleryLoopSectionComponent, DiscoverInterMarksSectionComponent, DiscoverContributionSectionComponent],
